...
#define STRING_CONFIG_H_AUTHOR "(Jeffry Bobb, default config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "DevilMEnder"
...
#define PREHEAT_1_FAN_SPEED   105 // Value from 0 to 255
...
#define LCD_FEEDBACK_FREQUENCY_HZ 10000
